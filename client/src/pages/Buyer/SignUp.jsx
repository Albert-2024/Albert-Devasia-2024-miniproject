...
const SignUp = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = (e) => {
        ...
        // Handle validation and MongoDB integration here
      };
                                ...
                                <div class="col-xl-6">
                                    <div class="card-body p-md-5 text-black">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <div class="form-outline">
                                                    ...
                                                    <label class="form-label"
                                                     for="form3Example1m">First name</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <div class="form-outline">
                                                    ...
                                                    class="form-control form-control-lg" />
                                                    <label class="form-label" 
                                                    for="form3Example1n">Last name</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                <div class="form-outline">
                                                    ...
                                                    class="form-control form-control-lg" />
                                                    <label class="form-label" 
                                                    for="form3Example1m1">Mother's name</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <div class="form-outline">
                                                    ...
                                                    for="form3Example1n1">Father's name</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <label 
                                            class="form-label" 
                                            for="form3Example99">Course</label>
                                        </div>
